...
if __name__ == "__main__":
    ...
    spark = (SparkSession.builder
             ...
             .config("spark.jars",
                     "/Users/nguyennam/Desktop/Realtime-Election-Voting-Engine/resources/postgresql-42.7.3.jar")  # PostgreSQL driver
    ...
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/Users/nguyennam/Desktop/Realtime-Election-Voting-Engine/checkpoints/checkpoint1") \
        .outputMode("update") \
        .start()
    ...
    turnout_by_location_to_kafka = turnout_by_location.selectExpr("to_json(struct(*)) AS value") \
        ...
        .option("checkpointLocation", "/Users/nguyennam/Desktop/Realtime-Election-Voting-Engine/checkpoints/checkpoint2") \
        .outputMode("update") \
        .start()
